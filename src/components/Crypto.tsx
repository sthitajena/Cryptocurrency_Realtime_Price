    ...
    <div className="flex flex-col mb-4 ml-0 p-4 border-2 border-gray-600 border-solid rounded shadow-lg w-full md:w-80 md:m-4">
      ...
      <div className="flex align-middle justify-between">
        <div className="flex flex-col">
          ...
          <span className="font-medium text-green-500">{coin.volume}</span>
        </div>

        <div className="flex flex-col">
          <span className="text-sm">Openprice:</span>
          <span className="font-medium text-gray-500">{coin.openPrice}</span>
        </div>

        <div className="flex align-middle justify-between">
          <div className="flex flex-col">
            <span className="text-sm">Lowprice:</span>
            <span className="font-medium text-gray-500">{coin.lowPrice}</span>
          </div>
        </div>
      </div>
    </div>
